...
Gradle 提供了使用 kotlin 编写构建脚本的支持，你可以将脚本重命名为 `build.gradle.kts`，然后使用本教程提供的 kts 写法代替之前的写法。

:::tip

如欲进一步了解 Gradle，可参阅 [Gradle 官方用户指南](https://docs.gradle.org/current/userguide/userguide.html)。

如欲进一步了解使用 Kotlin 编写 Gradle 脚本，可参阅 [Gradle Kotlin DSL 入门](https://docs.gradle.org/current/userguide/kotlin_dsl.html#kotlin_dsl)。
...
<TabItem value="core-kts" label="核心代码（kts）">
...
<TabItem value="full-kts" label="完整代码（kts）">
    <CodeBlock language="kotlin" metastring="{22-24}" title="build.gradle.kts" showLineNumbers>{BuildGradleKotlin}</CodeBlock>
</TabItem>
</Tabs>
...
<TabItem value="full-kts" label="完整代码（kts）">
    <CodeBlock language="kotlin" metastring="{30-78}" title="build.gradle.kts" showLineNumbers>{BuildGradleKotlin}</CodeBlock>
</TabItem>
</Tabs>
...
<TabItem value="full-kts" label="完整代码（kts）">
    <CodeBlock language="kotlin" metastring="{89-102}" title="build.gradle.kts" showLineNumbers>{BuildGradleKotlin}</CodeBlock>
</TabItem>
</Tabs>
