...
<TabItem value="full" label="完整代码">
    <CodeBlock language="groovy" metastring="{21-57}" title="build.gradle" showLineNumbers>{BuildGradle}</CodeBlock>
</TabItem>
</Tabs>
...
<TabItem value="full" label="完整代码">
    <CodeBlock language="groovy" metastring="{69-81}" title="build.gradle" showLineNumbers>{BuildGradle}</CodeBlock>
</TabItem>
</Tabs>
